...
func (m *PreferenceModule) Imports() []types.Module { return []types.Module{ROUTES, sql.Child(&sql.Config{})} }
func (m *PreferenceModule) Exports() []any { return []any{&PreferenceService{}} }
func (m *PreferenceModule) Declarations() []any { return []any{&PreferenceService{}, &PreferenceEntity{}} }
