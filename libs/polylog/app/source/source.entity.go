...
func (Source) TableName() string { return "PolylogSources" }

type SourceEntity struct {
	*sql.Entity[Source] `inject:""`
}

func (e *SourceEntity) OnRegister() {
	e.Hydrate("PolylogSources", []string{"user_id", "workspace_id", "category", "type_id"}, nil, nil, nil, nil, nil, "created_at desc")
}
